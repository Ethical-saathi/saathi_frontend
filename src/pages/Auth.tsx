               ...
               {view === "consent" && (
                 ...
                 >
                    <div className="w-14 h-14 rounded-2xl bg-white/50 backdrop-blur-sm shadow-[inset_0_2px_10px_rgba(255,255,255,0.8)] border border-white/60 flex items-center justify-center mx-auto mb-3 shrink-0">
                      <Shield className="w-7 h-7 text-teal-600 drop-shadow-sm" strokeWidth={1.5} />
                    </div>
                    ...
                    <div className="flex items-center gap-3 w-full shrink-0">
                      ...
                      <button
                        ...
                        className="clay-button w-2/3 bg-gradient-to-r from-teal-400 to-emerald-400 text-white font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-all duration-300 disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed"
                      >
