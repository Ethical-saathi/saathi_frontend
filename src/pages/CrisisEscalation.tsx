          ...
          <div className={cn(
            ...
            <div className="flex-1 bg-[#F1F8F6] border-[2px] border-[#A6D4CB] rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-[24px] flex flex-col items-center text-center gap-[12px]">
              ...
              <div className="flex flex-col items-center mt-1 w-full">
                <a 
                  href="tel:9152987821"
                  className="flex items-center justify-center gap-[8px] bg-[#F4845F] text-white rounded-[12px] px-[24px] py-[14px] text-[14px] font-medium w-full max-w-[200px] hover:bg-[#E06B4D] transition-all duration-150 ease-out hover:scale-[1.04]"
                >
