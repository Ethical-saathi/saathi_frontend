        ...
        >
          <div className="flex flex-col gap-3 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-1">
              <button 
                onClick={onSave}
                className="flex flex-1 items-center justify-center gap-2 bg-[#F4845F] text-white rounded-xl px-4 py-2.5 text-[14px] font-medium hover:bg-[#E06B4D] transition-colors"
              >
