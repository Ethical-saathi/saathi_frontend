    ...
    <div className="flex flex-col w-full text-left max-w-[650px] mx-auto pt-6 px-4 pb-20">
      ...
      <div className="w-full relative mb-12">
        <textarea
          ...
          className="w-full text-[18px] sm:text-[22px] leading-relaxed text-slate-700 bg-transparent border-0 border-b-2 border-slate-300 focus:border-[#5BA8A0] focus:ring-0 resize-none min-h-[60px] p-0 transition-colors placeholder:text-slate-400 placeholder:font-normal font-medium overflow-hidden outline-none"
          rows={1}
        />
      </div>
      ...
      <div className="flex flex-col items-center w-full mt-auto">
        <button
          ...
          className={cn(
            "clay-button w-full sm:w-[60%] bg-gradient-to-r from-teal-400 to-emerald-400 text-white font-semibold flex items-center justify-center py-4 rounded-full text-[17px] transition-all duration-300",
