  ...
  return (
    <div className="flex flex-col w-full h-[100dvh] items-center justify-center relative -mt-10">
      ...
      <div className="relative w-48 h-48 flex items-center justify-center mb-10 shrink-0">
        {/* Core center dot */}
        <div className="absolute w-4 h-4 bg-[#F4845F] rounded-full z-10" />
        
        {/* Concentric expanding ripples */}
        <div className="absolute w-16 h-16 border-2 border-[#F4845F]/60 rounded-full animate-ripple-expand" style={{ animationDelay: "0s" }} />
        <div className="absolute w-16 h-16 border-2 border-[#F4845F]/40 rounded-full animate-ripple-expand" style={{ animationDelay: "0.8s" }} />
        <div className="absolute w-16 h-16 border-2 border-[#F4845F]/20 rounded-full animate-ripple-expand" style={{ animationDelay: "1.6s" }} />
      </div>
      ...
      <div className="text-center flex flex-col items-center gap-6">
        ...
        >
          {displayedText}
          {!showSetup && <span className="animate-pulse opacity-50 ml-1 text-[#F4845F]">|</span>}
        </h2>
